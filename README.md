Questo programma permette all'utente di calcolare il perimetro e l'area dei primi 8 poligoni regolari (dal triangolo equilatero al decagono), inserendo lui stesso i dati necessari al calcolo.
